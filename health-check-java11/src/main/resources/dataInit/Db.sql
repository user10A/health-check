...
VALUES(1, 'Анестезиология'),
      ...
      (19, 'Ревмотопатия'),
      (20, 'Нейрохирургия');
INSERT INTO schedule (id, start_date_work, end_date_work, start_day_time, end_day_time, start_break_time, end_break_time, interval_in_minutes, department_id)
VALUES(1, '2024-01-15', '2024-02-15', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'FIFTEEN', 1),
      (2, '2024-01-16', '2024-02-16', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'FIFTEEN', 2),
      (3, '2024-01-17', '2024-01-17', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'FIFTEEN', 3),
      (4, '2024-01-18', '2024-02-18', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'FIFTEEN', 4),
      (5, '2024-01-19', '2024-02-19', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'FIFTEEN', 5),
      (6, '2024-01-20', '2024-02-20', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'FOURTYFIVE', 6),
      (7, '2024-01-21', '2024-02-21', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'FOURTYFIVE', 7),
      (8, '2024-01-22', '2024-02-22', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'FOURTYFIVE', 8),
      (9, '2024-01-23', '2024-02-23', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'FOURTYFIVE', 9),
      (10, '2024-01-24', '2024-02-24', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'FOURTYFIVE', 10),
      (11, '2024-01-25', '2024-02-25', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'SIXTY', 11),
      (12, '2024-01-26', '2024-02-26', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'SIXTY', 12),
      (13, '2024-01-27', '2024-02-27', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'SIXTY', 13),
      (14, '2024-01-28', '2024-02-28', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'SIXTY', 14),
      (15, '2024-01-29', '2024-02-29', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'SIXTY', 15),
      (16, '2024-01-30', '2024-02-01', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'THIRTY', 16),
      (17, '2024-01-31', '2024-03-01', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'THIRTY', 17),
      (18, '2024-02-01', '2024-03-01', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'THIRTY', 18),
      (19, '2024-02-02', '2024-03-02', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'THIRTY', 19),
      (20, '2024-02-03', '2024-03-03', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'THIRTY', 20),
      (21, '2024-02-04', '2024-03-04', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'NINETY', 1),
      (22, '2024-02-05', '2024-03-05', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'NINETY', 2),
      (23, '2024-02-06', '2024-03-06', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'NINETY', 3),
      (24, '2024-02-07', '2024-03-07', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'NINETY', 4),
      (25, '2024-02-08', '2024-03-08', '08:00:00', '17:00:00', '12:00:00', '13:00:00', 'NINETY', 5);
INSERT INTO doctor (id, first_name, last_name, image, position, description, is_active, schedule_id, department_id)
VALUES(1, 'Logan', 'Wells', 'profile.jpg', 'Forensic Pathologist', 'Expert in determining the cause of death through post-mortem examinations.', true, 1, 1),
      (2, 'Addison', 'Howard', 'profile.jpg', 'Neonatologist', 'Dedicated to the care of newborns, especially those born prematurely or with medical issues.', true, 2, 2),
      (3, 'Michael', 'Smith', 'profile.jpg', 'Dermatologist', 'Expert in skin-related conditions and treatments.', true, 3, 3),
      (4, 'Emily', 'Johnson', 'profile.jpg', 'Orthopedic Surgeon', 'Specialized in orthopedic surgery and musculoskeletal disorders.', true, 4, 4),
      (5, 'Christopher', 'Brown', 'profile.jpg', 'Pediatrician', 'Dedicated to childrens health and well-being', true, 5, 5),
      (6, 'William', 'Taylor', 'profile.jpg', 'Urologist', 'Specialized in urinary tract disorders and surgeries.', true, 6, 6),
      (7, 'Olivia', 'Davis', 'profile.jpg', 'Ophthalmologist', 'Expert in eye care and vision-related issues.', true, 7, 7),
      (8, 'Daniel', 'Anderson', 'profile.jpg', 'Endocrinologist', 'Focus on hormonal disorders and endocrine system health.', true, 8, 8),
      (9, 'Emma', 'White', 'profile.jpg', 'Rheumatologist', 'Specialized in autoimmune and musculoskeletal disorders.', true, 9, 9),
      (10, 'Alexander', 'Martinez', 'profile.jpg', 'ENT Specialist', 'Expert in ear, nose, and throat conditions and surgeries.', true, 10, 10),
      (11, 'Sophie', 'Moore', 'profile.jpg', 'Psychiatrist', 'Dedicated to mental health and psychological well-being.', true, 11, 11),
      (12, 'James', 'Harris', 'profile.jpg', 'Gynecologist', 'Specialized in women\s reproductive health.', true, 12, 12),
      (13, 'Grace', 'Nelson', 'profile.jpg', 'Pulmonologist', 'Focus on respiratory system disorders and treatments.', true, 13, 13),
      (14, 'Andrew', 'Carter', 'profile.jpg', 'Allergist', 'Expert in allergies and immunological disorders.', true, 14, 14),
      (15, 'Mia', 'Cooper', 'profile.jpg', 'Geriatrician', 'Dedicated to the health and well-being of the elderly.', true, 15, 15),
      (16, 'Liam', 'Robinson', 'profile.jpg', 'Sports Medicine Specialist', 'Expert in sports-related injuries and treatments.', true, 16, 16),
      (17, 'Aria', 'Hill', 'profile.jpg', 'Infectious Disease Specialist', 'Focus on infectious diseases and their treatments.', true, 17, 17),
      (18, 'Henry', 'Wright', 'profile.jpg', 'Nephrologist', 'Specialized in kidney-related disorders and treatments.', true, 18, 18),
      (19, 'Ella', 'Fisher', 'profile.jpg', 'Plastic Surgeon', 'Expert in cosmetic and reconstructive plastic surgery.', true, 19, 19),
      (20, 'Benjamin', 'Lopez', 'profile.jpg', 'Hematologist', 'Focus on blood disorders and related treatments.', true, 20, 20),
      (21, 'Lily', 'Baker', 'profile.jpg', 'Interventional Radiologist', 'Specialized in minimally invasive radiological procedures.', true, 21, 1),
      (22, 'William', 'Gomez', 'profile.jpg', 'Invasive Cardiologist', 'Expert in advanced cardiac interventions.', true, 22, 2),
      (23, 'Zoe', 'Perez', 'profile.jpg', 'Pain Management Specialist', 'Focus on managing chronic pain conditions.', true, 23, 3),
      (24, 'Samuel', 'Russell', 'profile.jpg', 'Sleep Medicine Specialist', 'Dedicated to diagnosing and treating sleep disorders.', true, 24, 4),
      (25, 'Victoria', 'Foster', 'profile.jpg', 'Podiatrist', 'Expert in foot and ankle conditions and surgeries.', true, 25, 5);
...
VALUES(1, '2024-01-15', '10:00:00', 'CANCELLED', false, 1, 1, 1),
      ...
      (6, '2024-01-20', '13:00:00', 'CONFIRMED', false, 6, 6, 6),
      (7, '2024-01-21', '10:45:00', 'CANCELLED', false, 7, 7, 7),
      (8, '2024-01-22', '10:30:00', 'CONFIRMED', false, 8, 8, 8),
      ...
      (20, '2024-02-03', '15:45:00', 'CONFIRMED', false, 20, 20, 20);
...
VALUES(1, '2024-01-15', '10:30:00', '/path/to/result.pdf', 12345, 1, 1),
      ...
      (6, '2024-01-20', '13:30:00', '/path/to/result_urology.pdf', 43210, 6, 6),
      (7, '2024-01-21', '11:00:00', '/path/to/result_ophthalmology.pdf', 10987, 7, 7),
      ...
      (13, '2024-01-27', '09:30:00', '/path/to/result_pulmonology.pdf', 12345, 13, 13),
      (14, '2024-01-28', '16:15:00', '/path/to/result_allergy_immunology.pdf', 76543, 14, 14),
      ...
      (20, '2024-02-03', '16:15:00', '/path/to/result_forensic_pathology.pdf', 23456, 20, 20);
...
VALUES(1, '2024-01-15', '10:00:00', '10:15:00', true, 1),
      ...
      (5, '2024-01-19', '16:30:00', '16:45:00', true, 5),
      (6, '2024-01-20', '13:00:00', '13:45:00', true, 6),
      (7, '2024-01-21', '10:45:00', '11:30:00', true, 7),
      (8, '2024-01-22', '10:30:00', '11:15:00', true, 8),
      (9, '2024-01-23', '15:15:00', '14:00:00', true, 9),
      (10, '2024-01-24', '08:30:00', '09:15:00', true, 10),
      (11, '2024-01-25', '11:00:00', '12:00:00', true, 11),
      (12, '2024-01-26', '14:45:00', '15:45:00', true, 12),
      (13, '2024-01-27', '09:15:00', '10:15:00', true, 13),
      (14, '2024-01-28', '16:00:00', '17:00:00', true, 14),
      (15, '2024-01-29', '10:30:00', '11:30:00', true, 15),
      ...
      (20, '2024-02-03', '15:45:00', '15:45:00', true, 20);
